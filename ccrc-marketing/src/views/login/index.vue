...
<script>
  ...
  data() {
      return {
        ...
        loginRules: {
          username: [{ required: true, trigger: 'blur',message: valid_error_msg.login.username }],
          password: [{ required: true, trigger: 'blur',message: valid_error_msg.login.passWord }]
        },
      ...
      handleLogin() {
        ...
        self.$refs.loginForm.validate(valid => {
          if (valid) {
            ...
            self.$store.dispatch('user/login', loginForm).then(() => {
                // 跳转到退出前的页面
