...
Vue.use(Router)
import async_routers from './modules/index';
...
export const constantRoutes = [
  ...
  },
  {
   ...
   {
     path:'/',
     redirect:getAccount_type()==='P'||getAccount_type()==='S'?'/select_team':'/workbench/workbench/index',
   },
   {
     path:'/select_team',
...
// export const asyncRoutes_CCRC = [
//   async_routers.housing,
// ]
export const asyncRoutes = [
  // {
  //   path: '/select_team',
  //   name: "select_team",
  //   component: views_dir["select_item"],
  //   hidden: true,
  // },
  {
    path: '/workbench',
    ...
    children: [
      {
        ...
        component: views_dir["workbenchIndex"],
        name: 'workbenchIndex',
        hidden: true,
        meta: {
          title: '工作台', icon: 'work',
      ...
      async_routers.sum, //统计
      async_routers.marketing, //营销 
      async_routers.goLive,//入住
      async_routers.inLive,//在住
      async_routers.outLive,//退住
      async_routers.services,//服务
      async_routers.assess,//评估
      async_routers.eating,//饮食
      async_routers.finance,//财务
      async_routers.rearServices,//后勤
      async_routers.administrative,//行政
      async_routers.basicConfig,//基础
      async_routers.system//系统
    ]
  },
