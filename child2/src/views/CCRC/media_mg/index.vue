  ...
  <div class="container">
    <div class="container_card">
      <el-row style="line-height: 80px; margin-top: -30px">
        <el-col :span="6">
          <div class="title">媒体管理列表</div>
        </el-col>
        <el-col :span="18" style="text-align: right">
          <el-button
            type="primary"
            icon="el-icon-plus"
            @click="handleDialog('添加媒体')"
            >添加媒体</el-button
          >
        </el-col>
      </el-row>
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="11">
            <el-form-item class="must-fill" label="媒体名称" prop="name">
              <el-input clearable v-model="form_data.name"></el-input>
            </el-form-item>
          </el-col>
          <el-col></el-col>
          <el-col :span="24">
            <el-form-item class="optional" label="媒体描述" prop="desc">
              <el-input
                type="textarea"
                clearable
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      let data = await get_media_page(params);
      ...
      self.$refs["form"].validate(async (valid) => {
        if (valid) {
          let params = {
            ...
            mediaDesc: self.form_data.desc,
          };
          add_media(params).then((res) => {
            self.$notify({
              type: "success",
              message: "操作成功",
              title: "成功",
    ...
    handleSubmit_edit() {
      ...
      self.$refs["form"].validate(async (valid) => {
        if (valid) {
          ...
          modify_media(id, params).then((res) => {
            self.$notify({
              type: "success",
              message: "操作成功",
              title: "成功",
