  ...
  <div class="container">
    ...
    <div class="container_card">
      ...
      >
        ...
        <el-table-column align="center" width="100" prop="headUrl" label="头像">
          <template slot-scope="scope">
            <el-image
        ...
        <el-table-column align="center" width="120" prop="elderName" label="姓名"></el-table-column>
        <el-table-column align="center" width="120" prop="bedName" label="床位"></el-table-column>

        <el-table-column align="center" width="120" prop="disease" label="疾病"></el-table-column>
        <el-table-column align="center" width="150" show-overflow-tooltip  prop="fixedFood" label="固定特殊膳食"></el-table-column>
        <el-table-column align="center" width="150" show-overflow-tooltip  prop="breakfast" label="特殊早餐主食"></el-table-column>
        <el-table-column align="center" width="150" show-overflow-tooltip  prop="lunch" label="特殊中餐主食"></el-table-column>
        <el-table-column align="center" width="150" show-overflow-tooltip  prop="dinner" label="特殊晚餐主食"></el-table-column>
        <el-table-column align="center" width="150" prop="startTime" label="开始时间"></el-table-column>
        <el-table-column align="left" width="357" prop="endTime" label="结束时间"></el-table-column>
        <el-table-column align="left" width="110"  label="操作" class="lastColumn">
          <template slot-scope="scope">
