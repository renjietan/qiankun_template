<!-- 
 * @description: 特殊事项记录表
 * @fileName: services_record_special_things.vue 
 * @author: 谭人杰 
...
<template>
    <div class='container'>
        <div class="container_card">
            <div class="title" style="margin-bottom: 20px;">特殊事项记录表</div>
                ...
                for (let i of r) {
                    ...
                    for (let item of t) {
                        ...
                        for (let child of s) {
                            ...
                            obj[`${this.Calendar_obj.format(new Date(obj.serviceDate))}（${temp_index}）`] = child.times
                        }
                    }
                    table_data.push(obj)
                }
