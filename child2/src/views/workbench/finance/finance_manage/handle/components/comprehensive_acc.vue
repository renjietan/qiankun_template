<!-- 
 * @description:综合备用金 
 * @fileName: comprehensive_acc.vue 
 * @author: 姜纬杰 
 * @date: 2021-09-09 17:36:50
 * @后台人员:  
!-->
<template>
  <div>
    <div>
      ...
      <div class="title" style="margin-bottom: 20px">
        ...
        <div style="display: inline-block">
          ...
          <el-button type="success" icon="el-icon-upload2" @click="handleAction('', '导出')">导出</el-button>
          <el-button type="primary" icon="el-icon-printer" @click="handleAction('', '打印')">打印</el-button>
        </div>
      </div>
      <el-table
        class="table_data"
      ...
      >
        ...
        <el-table-column align="left" width="150" prop="bedName" label="时间"></el-table-column>
        <el-table-column align="center" width="120" prop="bedName" label="账户操作类型"></el-table-column>
        <el-table-column align="center" width="130" prop="bedName" label="入账金额（元）"></el-table-column>
        <el-table-column align="center" width="130" prop="bedName" label="出账金额（元）"></el-table-column>
        <el-table-column align="center" width="200" prop="bedName" label="余额（元）"></el-table-column>
        <el-table-column align="center" width="200" prop="bedName" label="经办人"></el-table-column>
        <el-table-column align="left" width="558" prop="bedName" label="说明"></el-table-column>
