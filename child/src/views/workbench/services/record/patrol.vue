<!-- 
 * @description: 巡视记录表
 * @fileName: services_record_patrol.vue 
 * @author: 谭人杰 
...
<template>
    <div class='container'>
        <div class="container_card">
            <div class="title" style="margin-bottom: 20px;">巡视记录表</div>
        ...
        <div class="container_card">
            ...
            <el-table border :cell-class-name="tableCellClassName" class="table_data" border ref="table_data"
                ...
                <el-table-column fixed align="center" width="120" prop="elderName" label="姓名"></el-table-column>
                <el-table-column fixed align="center" width="120" prop="bedName" label="床位"></el-table-column>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center">
                <div class="footer_score">
                    <div class="footer_score" v-for="item in patrol_score" :key="item.label">
...
<script>
    ...
    import { patrol_score } from '@/utils/enum';
