...
<template>
  <div style="padding-bottom: 20px">
    ...
    <div>
      <el-table border :span-method="objectSpanMethod" ref="data_table" :data="table_data" v-loading="table_loading">
        <el-table-column width="150" align="center" prop="projectName" label="服务项目"></el-table-column>
    ...
    methods: {
      ...
      handleSubmit() {
        ...
        let params = {
          ...
          elderId: self.$route.query.id??self.$route.params.id,
