<!-- 
 * @description: 
 * @fileName: purchasing_aduit.vue 
 * @author: 王文涛 
 * @date: 2022-02-21 15:48:44
 * @后台人员:  
!-->
<template>
  <div class="container">
      ...
      >
        <el-row>
          <el-col :span="24">
            <el-row :gutter="20">
              <el-col :span="6">
                <el-form-item label="审核人:" class="default">
                  <el-input
                    readonly
                    clearable
                    v-model="form_data.warehouse"
              ...
              <el-col :span="6">
                <el-form-item label="审核日期" class="must-fill">
                  <el-date-picker
                    v-model="form_data.date"
                    type="date"
                    placeholder="选择日期"
             ...
             <el-col :span="24">
                <el-form-item label="审核意见:" class="default">
                  <el-input
