  ...
  <div class="container">
    <div class="container_card">
      <el-row style="line-height: 80px;margin-top: -30px;">
        <el-col :span="6">
          <div class="title">集团列表</div>
        </el-col>
        <el-col :span="18" style="text-align: right;">
          <el-button type="primary" icon="el-icon-plus" @click="handleDialog('添加集团')">添加集团</el-button>
        </el-col>
      </el-row>
      <el-table border ref="data_table" :data="table_data" v-loading="table_loading" fit>
        ...
        <el-table-column width="200" align="center" prop="avType" label="集团名称"></el-table-column>

        <el-table-column align="center" prop="rsv" label="说明"></el-table-column>
        <el-table-column width="200" align="center" label="操作">
          <template slot-scope="scope">
            <el-link type="primary" @click="handleDialog('编辑集团',scope)" :underline="false">编辑</el-link>
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="11">
            <el-form-item class="must-fill" label="集团名称" prop="avType">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="dialog_cof.title == '编辑集团' ? handleSubmit_edit() : handleSubmit_create()"
        >确 认</el-button>
      </div>
    </el-dialog>
  </div>
